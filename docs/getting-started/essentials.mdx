...
**Tools** give the model abilities it can call during a response. Open WebUI supports three kinds:

| Source | What it does | Examples |
| :--- | :--- | :--- |
| **Built-in** | System tools integrated into Open WebUI's core. | Web Search, Code Interpreter, Image Generation, Memory, Notes, Knowledge retrieval |
| **Custom** | Tools you write yourself or install from the [community site](https://openwebui.com/). Manage in **Workspace > Tools**. | Langfuse / OpenLit observability, Home Assistant, arXiv / PubMed lookups, Wolfram Alpha, Jira / Linear, SQL queries |
| **External servers** | Remote tool servers connected via **MCP** or **OpenAPI** specs. No plugin code required. Configure in **Admin Panel > Settings > Tools**. | Your own microservices, third-party APIs, existing MCP servers |
