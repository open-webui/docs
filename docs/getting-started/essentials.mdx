...
:::info Good to know
By default, background tasks (titles, tags, follow-ups) use your main chat model, and autocomplete is off until an admin turns it on. Setting a dedicated task model is the easiest way to improve speed and reduce unnecessary API costs.
:::
