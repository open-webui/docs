...
- **Task Model (External)**: Set to a fast, cheap, *non-reasoning* cloud model like `gpt-5.4-nano`, `gemini-3.5-flash-lite`, or `claude-haiku-4-5-20251001`.
- **Task Model (Local)**: Set to a tiny local model like `qwen3.5:2b`, `gemma4:e2b`, or `llama3.2:3b`.
