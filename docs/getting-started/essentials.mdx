...
It is a built-in tool, so there is nothing to install. The one decision is **which search provider to use**, and Open WebUI supports over twenty of them. They fall into three rough groups:
...
- **Free, no sign-up.** [**DuckDuckGo (DDGS)**](/features/chat-conversations/web-search/providers/ddgs) needs no key, which makes it the quickest way to try the feature.
- **Commercial APIs.** [**Tavily**](/features/chat-conversations/web-search/providers/tavily), [**Brave**](/features/chat-conversations/web-search/providers/brave), [**Exa AI**](/features/chat-conversations/web-search/providers/exa), [**Google PSE**](/features/chat-conversations/web-search/providers/google-pse) and others trade an API key (and usually a bill) for higher-quality, AI-tuned results.
