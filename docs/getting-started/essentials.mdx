...
3. **Within the first week:** Enable the built-in tools you want (web search, image generation, code execution, memory) and install one or two community Tools that match your work.
