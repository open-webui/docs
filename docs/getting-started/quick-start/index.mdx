...
<Tabs>
  ...
  <TabItem value="third-party" label="Third Party">
    <Tabs>
      ...
      <TabItem value="lynxhub" label="LynxHub">
        ## Install with LynxHub
          Follow these steps to install Open WebUI in LynxHub
          1. Install [**LynxHub**](https://github.com/KindaBrazy/LynxHub)
          2. In the app search for **Open WebUI** and install
          3. Press ▶️ button to start
        ## Manage Environment Variable
          You can manage **Environment Variable** by these steps:
                - Click on **three dots** to open menu then **Launch Config**
                - Click on **+** icon and add your desire environment variable
                - **Save**
        ## Update
          The App will check for updates **automatically**, for manual checking:
