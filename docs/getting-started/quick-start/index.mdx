...
If this is your first time with Open WebUI, read the [**Open WebUI 101**](/getting-started/essentials) guide next. It covers the six things every new user needs to know: plugins, task models, context management, tool calling, RAG, and Open Terminal.
