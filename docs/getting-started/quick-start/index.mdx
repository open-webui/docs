...
Want to test the latest features or contribute to Open WebUI? Use the `:dev` Docker tag to run the latest development build, or check out the [Local Development Guide](/getting-started/development) to set up a full dev environment from source.
