...
- **Privacy:** All data, including login details, is stored locally on your device. Open WebUI does not make external requests by default. All models are private by default and must be explicitly shared.
