...
Want to connect an autonomous AI agent (with terminal access, web search, file operations, and more) instead of a plain model provider? See the [**Connect an Agent**](/getting-started/quick-start/connect-an-agent) guide.
