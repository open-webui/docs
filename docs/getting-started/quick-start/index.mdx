...
For a component-level view of the web interface, application server, model connections, storage, RAG, and extensions, see [**How Open WebUI Works →**](/getting-started/how-it-works).
