...
<Tabs>
  <TabItem value="docker" label="Docker">
    ...
    <TabItem value="podman-kube-play" label="Kube Play">
      ...
      <TabItem value="development" label="Beta/Development">
        <div className='mt-5'>

### Beta/Development

See [Using the Dev Branch 🌙](#using-the-dev-branch-) in the Docker tab above, or check out the [Local Development Guide](/getting-started/development) to set up a full dev environment from source.
...
Want to test the latest features or contribute to Open WebUI? Our [Local Development Guide](/getting-started/development) walks you through cloning the repo, setting up the frontend and backend, and getting a full dev environment running from source.

If you prefer Docker, you can also use the [dev Docker image](/#using-the-dev-branch-) instead.

:::note

**For PostgreSQL Support:**

The default installation uses a slimmed-down package. If you need **PostgreSQL support**, install with all optional dependencies:
