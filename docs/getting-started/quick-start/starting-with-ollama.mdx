...
:::tip
The `deepseek_r1` parser works for most reasoning models, including Qwen3. If you encounter issues, see our [Reasoning Models Troubleshooting Guide](/troubleshooting/reasoning-models) for alternative parsers and detailed troubleshooting steps.
:::
