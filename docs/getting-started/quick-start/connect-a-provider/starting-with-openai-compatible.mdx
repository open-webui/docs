...
<Tabs>
  ...
  **Docker Model Runner** runs AI models directly in Docker containers.
  ...
  <TabItem value="rapid-mlx" label="Rapid-MLX">

  **Rapid-MLX** is an OpenAI-compatible inference server optimized for Apple Silicon (MLX). It delivers 2-4x faster inference than Ollama, with built-in tool calling, reasoning separation, and prompt caching.
  ...
  **Quick start:**
  ...
  See the [Rapid-MLX GitHub repo](https://github.com/raullenchai/Rapid-MLX) for more details and supported models.
