...
*   **[Functions Overview](/features/extensibility/plugin/functions/)**: Learn the basics of the Functions system.
*   **[Pipes Guide](/features/extensibility/plugin/functions/pipe)**: Create custom model providers and logic pipelines.
*   **[Filters Guide](/features/extensibility/plugin/functions/filter)**: Intercept and modify messages (Input/Output guards).
*   **[Actions Guide](/features/extensibility/plugin/functions/action)**: Add buttons/actions to messages.
*   **[Tools Guide](/features/extensibility/plugin/tools/)**: Build tools for LLMs to use (RAG, APIs).
