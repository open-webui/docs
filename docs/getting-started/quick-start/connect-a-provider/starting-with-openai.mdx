...
*   **Prefix ID**:
    *   If you connect multiple providers that have models with the same name (e.g., two providers both offering `qwen3.6`), add a prefix here (e.g., `groq/`) to distinguish them. The model will appear as `groq/qwen3.6`.
