...
```bash
docker pull ghcr.io/open-webui/open-webui:v0.9.7
docker pull ghcr.io/open-webui/open-webui:v0.9.7-cuda
docker pull ghcr.io/open-webui/open-webui:v0.9.7-ollama
```
