...
| Startup probe | HTTP `/ready` (503 until startup completes and the database and Redis, when configured, answer), port `8080`, 10-second period, 5-second timeout, failure threshold `24`. |
