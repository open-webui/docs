...
- A swipe that opens the sidebar has to start clear of the **leftmost 16 pixels**, so a screen-edge swipe still reaches your browser or phone. Closing works from anywhere.
