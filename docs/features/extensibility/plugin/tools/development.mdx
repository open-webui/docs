...
Only the reST `:param name:` form is read. A Google-style `Args:` block produces no parameter descriptions at all, and lands in the tool's own description instead.
