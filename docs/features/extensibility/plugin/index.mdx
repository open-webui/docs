...
2. **Featured does not mean vetted.** A plugin being highlighted, featured, popular, or listed on the [Open WebUI Community site](https://openwebui.com/) is **not** an endorsement and does **not** mean its code was reviewed for security or quality. Listings are community-submitted and unaudited. See [Community Plugins](/features/extensibility/plugin/community).
