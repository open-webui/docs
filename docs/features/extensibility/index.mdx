...
Featured or popular status on the community site is not a security or quality review, so read the code before you import. See [Community Plugins](plugin/community) for a beginner's guide to browsing and importing safely.
...
| [**Community Plugins**](plugin/community) | Browsing and importing community Tools and Functions safely |
