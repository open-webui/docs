...
Most of these settings can also be configured in the **Settings → Admin → Audio** tab. Environment variables take precedence on startup but can be overridden in the UI.
:::
