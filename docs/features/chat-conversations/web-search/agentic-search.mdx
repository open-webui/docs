...
Agentic web search needs a model that can call tools reliably and decide when to dig deeper. That does **not** mean a frontier model — cheap and fast is fine. **GPT-5.6 Luna**, **Gemini 3.5 Flash-Lite**, **MiniMax M3**, **DeepSeek V4 Flash**, or locally **Qwen 3.6 27B** or **Muse Glimmer 30B** all handle this well and are the **minimum**, each verified working at the time of writing. Only genuinely old or very small models struggle with the multi-step reasoning.
