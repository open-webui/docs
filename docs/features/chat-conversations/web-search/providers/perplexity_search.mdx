...
2. Under the **Perplexity Search API URL** field (`PERPLEXITY_SEARCH_API_URL`, default `https://api.perplexity.ai/search`), replace the default with your LiteLLM endpoint. The field holds the full search endpoint, not a base URL.
