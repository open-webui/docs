...
This applies to files picked from your device, Google Drive or OneDrive, as well as web pages and YouTube links added with **Attach Webpage** or by typing the URL after `#` or `@`. Attached notes, knowledge bases and chats hold nothing up, since nothing is uploaded for them.
