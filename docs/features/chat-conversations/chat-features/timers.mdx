...
- **The reply reports its token usage** like any other chat, provided the model has the **Usage** capability enabled. See [Capabilities and bindings](/features/workspace/models#capabilities-and-bindings).
