...
- **[⌨️ Keyboard Shortcuts](./keyboard-shortcuts.mdx)**: Rebindable shortcuts for the common actions, managed in **Settings > Keyboard**, plus how [keyboard navigation](./keyboard-shortcuts.mdx#keyboard-navigation) works across the rest of the interface.
