...
1.  **Enable Compare Mode**: In the model picker, click the <img src="/images/features/chat/multi-model-compare.svg" alt="" width="20" height="20" /> **Compare** button, shown beside the search field.
2.  **Select Models**: With comparison mode enabled, select the models you want to talk to simultaneously and compare.
...
3.  **Send Prompt**: Type your question as usual.
4.  **View Results**: Watch as all models generate their responses simultaneously in the chat window.
