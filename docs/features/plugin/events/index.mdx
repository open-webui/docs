...
| `source`,<br/>`citation`                     | Add a source/citation, or code execution result      | See [Citations Documentation](../citations) for full structure |
...
await __event_emitter__(
    {
        ...
        "data": {
            ...
            # See full structure: /docs/features/plugin/citations
        }
    }
)
```

For detailed citation structure, metadata properties, and advanced features, see the [Citations Documentation](../citations).
