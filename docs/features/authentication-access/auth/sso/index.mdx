...
:::tip
For a complete end-to-end guide covering installation, HTTPS, authentication, and Docker Compose setup, see the [**Tailscale Integration Tutorial**](/tutorials/integrations/tailscale).
:::
