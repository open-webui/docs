...
- **Check the global toggle:** Verify that an admin has enabled API keys in **Settings > Admin > General > API Keys**. See [`ENABLE_API_KEYS`](/reference/env-configuration#enable_api_keys).
