...
| 🖼️ **Image generation** | Create and edit images with GPT-Image, Gemini, ComfyUI, and more |
...
| | |
| :--- | :--- |
| 📄 **13 vector databases** | ChromaDB and PGVector (officially maintained), plus non-core integrations: Qdrant, Milvus, Elasticsearch, and more |
...
| 🎚️ **Default Interface Settings** | Instance-wide starting values for everyone's interface options |
...
| ⚖️ **Horizontal scaling** | Stateless application replicas with shared databases, storage, and Redis |

[**Quick Start →**](/getting-started/quick-start) · [**Scaling Guide →**](/getting-started/advanced-topics/scaling) · [**Advanced Topics →**](/getting-started/advanced-topics)
