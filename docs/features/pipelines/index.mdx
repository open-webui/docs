...
- [**Citations Pipeline**](https://github.com/open-webui/pipelines/blob/main/examples/pipelines/citations_example.py): Add source references and metadata to your responses with [Citations](../plugin/citations).
