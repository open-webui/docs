...
Open WebUI is where agents are prompted, governed, and observed. Terminals is where their workspaces are provisioned, isolated, reused, refreshed, and reset.
...
In agentic-infrastructure terms, Terminals owns the workspace lifecycle: provision, route, persist, reap, refresh, and reset.
