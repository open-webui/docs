...
We proudly acknowledge generous grants from:

<p>


  <a href="https://builders.mozilla.org/" title="Mozilla Builders 2024" target="_blank" rel="noopener">
    <img src="https://builders.mozilla.org/wp-content/uploads/2024/12/Builders_Social_Share.png" alt="Mozilla" width={"100%"} style={{verticalAlign:'middle',marginRight:'12px'}} />
  ...
  <a href="https://github.com/accelerator" title="GitHub Accelerator 2024" target="_blank" rel="noopener">
    <img src="https://github.blog/wp-content/uploads/2024/02/accelerator2024.jpg?w=1032" alt="GitHub" width={"100%"} style={{verticalAlign:'middle',marginRight:'16px'}} />
