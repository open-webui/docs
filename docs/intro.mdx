...
For GPU support, Docker Compose, and more → [Quick Start](/getting-started/quick-start) and [Docker images and tags](/getting-started/quick-start#image-variants)
...
- [**Quick Start**](/getting-started/quick-start): Docker, Python, Kubernetes and desktop app install options
...
- [**Development Branch**](/getting-started/quick-start#using-the-dev-branch): Help test the latest changes before stable release
