...
Installed Open WebUI but not sure where to start? The [**Open WebUI 101**](/getting-started/essentials) guide covers the six things every new user eventually needs to know: plugins, task models, context management, tool calling, RAG, and Open Terminal.
:::
...
- [**Open WebUI 101**](/getting-started/essentials) - Start here after your first install. Plugins, task models, context management, tool calling, RAG, Open Terminal.
