...
<img
  ...
  style={{ width: '100%', borderRadius: 12, margin: '0.25rem 0 0.5rem' }}
/>

<p style={{ fontSize: '0.85rem', opacity: 0.7, margin: '0 0 1.75rem' }}>
