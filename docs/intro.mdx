...
:::note
When using docker via Rancher Desktop, do not pass the flag `--add-host=host.docker.internal:host-gateway` as this configuration is Docker Desktop specific and doesn't work with Rancher Desktop.
:::
