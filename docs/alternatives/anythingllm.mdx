...
- **Advanced RAG pipeline** with 13 vector databases, 8 extraction engines, hybrid BM25 + vector search with cross-encoder reranking, and agentic retrieval
...
| **RAG approach** | 13 vector DBs, 8 extraction engines, hybrid search, reranking | Built-in vector DB with straightforward document ingestion |
