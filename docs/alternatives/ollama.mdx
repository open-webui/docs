...
- **Full agentic platform** on top of your local models, with [builtin tools](/features/extensibility/plugin/tools#built-in-system-tools-nativeagentic-mode) the model calls itself, [MCP](/features/extensibility/mcp) servers, [sub-agents](/features/chat-conversations/chat-features/subagents), [timers](/features/chat-conversations/chat-features/timers) and [automations](/features/chat-conversations/chat-features/automations)
...
- **Knowledge & RAG** with 13 vector DBs, 8 extraction engines, and hybrid search
