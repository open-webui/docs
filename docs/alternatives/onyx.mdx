...
Open WebUI's free edition against Onyx's Community Edition, the part carrying the MIT licence. Onyx's column follows its [Enterprise Edition](https://docs.onyx.app/deployment/miscellaneous/enterprise_edition) and [access control](https://docs.onyx.app/security/architecture/access_controls) documentation.

| Capability | Open WebUI (free) | Onyx Community Edition (free) |
| :--- | :--- | :--- |
| OIDC / OAuth single sign-on | ✅ Included | ❌ Enterprise Edition |
| SAML single sign-on | ❌ Not supported at any tier | ❌ Enterprise Edition |
| LDAP / Active Directory | ✅ Included | Not documented |
| User groups and role-based access control | ✅ Included | ❌ Enterprise Edition |
| Per-resource access grants (users and groups) | ✅ Included | ❌ Enterprise Edition |
| SCIM 2.0 provisioning | ✅ Included | Not documented |
| Audit logging | ✅ Included | Not documented |
| User limit before paying | ✅ None | ✅ None |
| Differentiated access per document | ❌ Per knowledge base only | ❌ Enterprise Edition |
| Permission inheritance from the source system | ❌ Not supported at any tier | ❌ Enterprise Edition |
| Removing product branding | ❌ Enterprise licence above 50 users | ❌ Enterprise Edition |
...
Nothing in Open WebUI's ✅ rows needs a licence key, a seat count or a paid plan. They are environment variables.

Read the bottom half of the table as carefully as the top. Open WebUI cannot express per-document access differences or inherit permissions from a source system at all, and Onyx can, once you are on its Enterprise Edition. Both projects reserve branding removal, dedicated support and priority on the roadmap for paying customers, which is how each is funded, and neither pretends otherwise.

On [Onyx Cloud](https://onyx.app/pricing) as of July 2026 the line falls elsewhere again, with role-based access control and permission inheritance included from the Business tier at $20 per user per month, and single sign-on reserved for the Enterprise tier.
...
| **SSO** | OIDC and OAuth in the free edition, unlimited users; no SAML | OIDC and SAML, [Enterprise Edition](https://docs.onyx.app/deployment/miscellaneous/enterprise_edition) self-hosted or Enterprise tier on Cloud |
