...
**A:** This happens if the model's thinking tags are not recognized by Open WebUI. You can customize the tags in the model's Advanced Parameters. For more details, see the **[Reasoning & Thinking Models](./features/chat-features/reasoning-models.mdx)** guide and our **[Reasoning Models Troubleshooting Guide](/troubleshooting/reasoning-models)**.
