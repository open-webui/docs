...
|  |  |
| :--- | :--- |
| **Class** | Inherent model behavior (prompt injection, jailbreaks, unsafe or hallucinated output) — OWASP LLM01 (Prompt Injection), LLM06 (Excessive Agency) and LLM09 (Misinformation) |
