...
| :--- | :--- | :--- | :--- |
| [LLM output unpredictability](./llm-output-unpredictability) | Inherent model behavior (OWASP LLM01 family) | System hardened around the model; model bound by caller's privileges | Inherent to LLMs; out of scope as a vulnerability |
