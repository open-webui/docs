...
Open WebUI is a self-hosted, authenticated, role-based application (see the [Security Policy](../security-policy)). The residual is further constrained by defence in depth that is already present:
