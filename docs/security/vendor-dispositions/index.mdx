...
### We are not the only ones who read these records this way

On 2026-09-02, a maintainer of the [GitHub Advisory Database](https://github.com/github/advisory-database/pull/8031#issuecomment-5512489251) stated that three advisories mirroring CVEs filed against Open WebUI had been left `unreviewed` on purpose, "due to concerns by teammates and I had about the validity of the vulnerabilities described in the CVE records". Because they are unreviewed, they raise no Dependabot alerts.

The three are one from each of the three CNAs that have filed against us:

| Advisory | CVE | Issuing CNA | Our assessment |
| :--- | :--- | :--- | :--- |
| [GHSA-vh96-p962-544h](https://github.com/advisories/GHSA-vh96-p962-544h) | CVE-2026-0767 | Zero Day Initiative | [Disposition](./cve-2026-0767.mdx) |
| [GHSA-2rf6-9rc8-rqch](https://github.com/advisories/GHSA-2rf6-9rc8-rqch) | CVE-2025-15603 | VulDB | [Disposition](./cve-2025-15603.mdx) |
| [GHSA-cfvq-fj53-j2c7](https://github.com/advisories/GHSA-cfvq-fj53-j2c7) | CVE-2024-7040 | huntr / Protect AI | [Disposition](./cve-2024-7040.mdx) |

This was decided independently, by people with no stake in the outcome and no contact with us about it, before any of the three records were withdrawn. All three have since been withdrawn by the CNA that issued them.

We record it because the objection this page most often meets is that a vendor disputing a CVE is simply a vendor that does not want a CVE. Here a third party who curates this data for a living, and who gains nothing either way, read the same records and reached the same conclusion we did.

It is also the clearest illustration of the asymmetry described above. Three records were doubted enough to be held back from the alerting pipeline, and were still circulating as published CVEs, with a severity and an affected version range, for as long as it took each CNA to withdraw them.
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| [CVE-2026-0765](./cve-2026-0765.mdx) | PIP install_frontmatter_requirements Command Injection | Zero Day Initiative | Rejected | <span className="badge badge--success">CNA REJECTED</span> | 2026-01-23 |
| [CVE-2026-0766](./cve-2026-0766.mdx) | load_tool_module_by_id Code Injection | Zero Day Initiative | Rejected | <span className="badge badge--success">CNA REJECTED</span> | 2026-01-23 |
| [CVE-2026-0767](./cve-2026-0767.mdx) | Cleartext Transmission of Credentials | Zero Day Initiative | Rejected | <span className="badge badge--success">CNA REJECTED</span> | 2026-01-23 |
...
| [CVE-2024-7036](./cve-2024-7036.mdx) | DoS via Oversized Signup Name | huntr / Protect AI | Rejected | <span className="badge badge--success">CNA REJECTED</span> | 2025-03-20 |
| [CVE-2024-7037](./cve-2024-7037.mdx) | Path Traversal in Pipeline Upload | huntr / Protect AI | Rejected | <span className="badge badge--success">CNA REJECTED</span> | 2024-10-09 |
...
| [CVE-2024-7045](./cve-2024-7045.mdx) | Prompt Disclosure via /api/v1/prompts/ | huntr / Protect AI | Rejected | <span className="badge badge--success">CNA REJECTED</span> | 2025-03-20 |
| [CVE-2024-7046](./cve-2024-7046.mdx) | Admin Details Disclosure via /api/v1/auths/admin/details | huntr / Protect AI | Rejected | <span className="badge badge--success">CNA REJECTED</span> | 2025-03-20 |
| [CVE-2024-7049](./cve-2024-7049.mdx) | Token Issued to Pending-Role Account | huntr / Protect AI | Rejected | <span className="badge badge--success">CNA REJECTED</span> | 2024-10-10 |
| [CVE-2024-7053](./cve-2024-7053.mdx) | Session Fixation via Markdown Image | huntr / Protect AI | Rejected | <span className="badge badge--success">CNA REJECTED</span> | 2025-03-20 |
| [CVE-2024-7806](./cve-2024-7806.mdx) | CSRF to Pipeline Code Execution | huntr / Protect AI | Rejected | <span className="badge badge--success">CNA REJECTED</span> | 2025-03-20 |
...
| [CVE-2024-7990](./cve-2024-7990.mdx) | Stored XSS via Model Description | huntr / Protect AI | Rejected | <span className="badge badge--success">CNA REJECTED</span> | 2025-03-20 |
| [CVE-2024-7999](./cve-2024-7999.mdx) | DoS via Malformed Multipart Boundary | huntr / Protect AI | Never disclosed to us | <span className="badge badge--success">CNA REJECTED</span> | 2025-03-20 |
| [CVE-2024-8060](./cve-2024-8060.mdx) | Path Traversal in Audio Transcription Upload | huntr / Protect AI | Rejected | <span className="badge badge--success">CNA REJECTED</span> | 2025-03-20 |
| [CVE-2024-9840](./cve-2024-9840.mdx) | DoS via Multipart Boundary on Upload Endpoints | huntr / Protect AI | Never disclosed to us | <span className="badge badge--success">CNA REJECTED</span> | 2025-03-20 |
| [CVE-2024-12534](./cve-2024-12534.mdx) | DoS via Oversized Sign-in Fields | huntr / Protect AI | Rejected | <span className="badge badge--success">CNA REJECTED</span> | 2025-03-20 |
| [CVE-2024-12537](./cve-2024-12537.mdx) | DoS via Code Format Endpoint | huntr / Protect AI | Rejected | <span className="badge badge--success">CNA REJECTED</span> | 2025-03-20 |
| [CVE-2024-12868](./cve-2024-12868.mdx) | DoS via Vulnerable starlette Dependency | huntr / Protect AI | Never disclosed to us | <span className="badge badge--success">CNA REJECTED</span> | 2025-03-20 |
