...
[Based on multiple precedents of foreign CNAs minting CVEs without communicating the report to us prior to publication, and/or minting CVEs that do not withstand scrutiny](https://docs.openwebui.com/security/vendor-dispositions/), this rule was established.
