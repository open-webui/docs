...
- Description: Sets the tile server used by Leaflet, which is rendered for `map` type prompt input variables and tool/function valves. See [Leaflet docs](https://leafletjs.com/reference.html#tilelayer). Can be used to render map tiles from a provider other than OpenStreetMap

#### `MAP_TILE_SERVER_ATTRIBUTION`

- Type: `str`
- Default: `&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors`
- Description: Passed to the `attribution` option in the Leaflet map used for `map` type prompt input variables. Accepts HTML. Set this whenever [`MAP_TILE_SERVER_URL`](#map_tile_server_url) points somewhere other than OpenStreetMap as per the attribution requirements of the chosen map tile server provider. See [Leaflet docs](https://leafletjs.com/reference.html#layer-attribution)
