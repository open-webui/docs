...
This page is up-to-date with Open WebUI release version [v0.8.13](https://github.com/open-webui/open-webui/releases/tag/v0.8.13), but is still a work in progress to later include more accurate descriptions, listing out options available for environment variables, defaults, and improving descriptions.
...
See [Permissions](/features/access-security/rbac/permissions#4-features-permissions) for role/permission behavior.
