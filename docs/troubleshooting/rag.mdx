...
You attached a webpage or a YouTube video to a chat (**+ > Attach Webpage**, or by typing the URL after `@`), and it came back as an error toast instead of a document.
...
```
400: [ERROR: Could not read content from https://example.com/page]
```
