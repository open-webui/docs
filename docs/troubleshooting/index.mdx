...
| SSO login ends with "The email or password provided is incorrect" and the log shows `Unsupported {'app_id'} in header` | [SSO → Vendor-specific ID token headers](./sso#cyberark-identity-apereo-cas-and-other-providers-with-vendor-specific-id-token-headers) |
