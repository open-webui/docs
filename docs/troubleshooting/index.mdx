...
**Want to help prevent issues like this from reaching stable releases?** Consider running the [development branch](/getting-started#using-the-dev-branch-)! Testing dev builds is one of the most valuable contributions you can make—no code required. Just use it and report any issues you find.
