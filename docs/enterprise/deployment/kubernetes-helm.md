...
For the complete Helm setup guide, see [Kubernetes Deployment](/deployment/kubernetes). For troubleshooting multi-replica issues, see [Multi-Replica Troubleshooting](/troubleshooting/multi-replica).
