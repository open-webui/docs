...
For the complete Helm setup guide, see [Kubernetes Deployment](/getting-started/deployment/kubernetes). For troubleshooting multi-replica issues, see [Multi-Replica Troubleshooting](/troubleshooting/multi-replica).
