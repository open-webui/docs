...
We selectively partner with **teams of 100+ seats** to provide the **dedicated attention and expertise you deserve**, ensuring a seamless path to success.  

Have **fewer than 100 seats** but still want **customization and enterprise features?** A **self-serve license** is coming by **end of Q2**—**stay tuned!**  
