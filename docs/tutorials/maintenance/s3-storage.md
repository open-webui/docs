...
| `azure`              | str      | Uses the Azure Blob Storage client with `AZURE_STORAGE_ENDPOINT`, `AZURE_STORAGE_CONTAINER_NAME` and `AZURE_STORAGE_KEY` | No          |
