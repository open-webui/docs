...
**Tools** are an exciting feature because they allow OpenAI-like models (LLMs) to do more than just process text. They provide **external abilities** that LLMs wouldn't otherwise have on their own.
