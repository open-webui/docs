...
## Step 3: Enable the Tool Server on your desired model 💡

Once your tool server is connected, you will need to manually enable it on the desired model.

![Tool Server Enablement Toggle](/images/openapi-servers/open-webui/model-enable.gif)

## Step 4: Confirm Your Tool Server Is Connected ✅
